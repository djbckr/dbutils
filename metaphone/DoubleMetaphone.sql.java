...
create or replace and compile java source named "DoubleMetaphone" as
package net.rubywillow;

/* This source was lifted from http://commons.apache.org/proper/commons-codec/
   Specifically the DoubleMetaphone class source. I didn't need anything else
   there, so I just did some simple mods to make it stand on its own. */
...
public class DoubleMetaphone {
        ...
        String[] err )
    {
      try {
        ...
        rslt[0] = db.doubleMetaphone(str, false);
        rslt_alt[0] = db.doubleMetaphone(str, true);
      } catch (Exception e) {
